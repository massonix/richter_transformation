...
As we can see, clusters 2 and 5 correspond to T cells, NK cells and monocytes. Cluster 3 contains mostly Richter-specific cells, so although it contains residual erythrocytes (HBM+) we will include it with the leukemic.

```{r}
microenv_clusters <- c("2", "5")
leuk_clusters <- c("0", "1", "3", "4", "6")
