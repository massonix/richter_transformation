...
`r path_to_image <- paste(path_to_knit, "2-QC/2-doublet_detection/tmp/histograms/scrublet_doublet_prediction_histograms-", subproject, "-", gem_id, ".png", sep = ""); sprintf("![](%s)", path_to_image)`
...
`r path_to_image <- paste(path_to_knit, "2-QC/2-doublet_detection/tmp/umaps/scrublet_doublet_prediction_umaps-", subproject, "-", gem_id, ".png", sep = ""); sprintf("![](%s)", path_to_image)`
